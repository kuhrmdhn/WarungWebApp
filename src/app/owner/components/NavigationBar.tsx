...
export default function NavigationBar() {
  ...
  return (
    <header className='w-full h-[15svh] sm:h-[13svh] bg-white flex flex-col sm:flex-row items-center justify-between'>
      <section className='w-full sm:w-2/5 h-1/2 sm:h-full flex justify-center items-center'>
        <Logo>
          <Logo.LogoBlack />
        </Logo>
      </section>
      <nav className='w-full sm:w-1/2 h-1/2 sm:h-full'>
