...
function ChefHeader() {
    ...
    return (
        <header className="w-full h-16 sm:h-24 lg:h-1/6 bg-chef-primary flex justify-around items-center">
            <Logo.LogoWhite />
            <span className="w-1/2 sm:w-1/3 lg:w-1/5 h-10">
            <SearchBar setKeyword={setSearchOrderGroupItem} placeholder={"Cari Nomor Pesanan"} />
            </span>
        </header>
    )
}
