...
function ReportChart() {
    ...
    return (
        <section className="w-full h-max lg:h-96">
            ...
            <div className="h-5/6 lg:h-full w-full flex flex-col gap-5 lg:flex-row justify-around sm:items-center lg:mt-8">
                <div className="lg:h-full sm:w-4/5 lg:w-1/2 flex flex-col justify-start items-start gap-3">
                    ...
                    <Chart.BarChart chartsData={productChartData} />
                </div>
